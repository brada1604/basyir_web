                    ...
                    <tr>
                        <td>
                            <table border="0" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                ...
                                <tr>
                                    <td align="center">
                                        <a href="" style=" border-style: none !important; border: 0 !important;"><img src="<?=base_url($glw->gambar_wawasan_islami);?>" style="display: block; width: 280px;" width="280" border="0" alt="" /></a>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="left" style="color: #3d3d3d; font-size: 22px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                                        ...
                                        <div style="line-height: 35px">
                                            ...
                                            <h1 class="mt-4 mb-4"><?= $glw->judul_wawasan_islami;?></h1>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;"
                                        ...
                                        <div style="line-height: 24px">
                                            ...
                                            <p class="mt-4"><?= $glw->ringkasan_wawasan_islami;?></p>
