            ...
            <div class="contact-form">
                ...
                <form id="ServiceRequest" action="<?php echo base_url('push/admin/send_message'); ?>" method='post'>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="url" class="form-control" placeholder="Add Your url" value="http://onesignal.loc" >
                    </div>
                    
                    <div class="form-group">
                        <label class="control-label">Your img:</label>
                        <input type="text" name="img" class="form-control" placeholder="Add Your img" value="http://onesignal.loc/img/pic.gif" >
                    </div>
                    ...
                    <div id='submit_button'>
                        ...
                        <input style="width: 100px;" onclick="location.href='/admin/logout';" class="btn btn-info pull-right" value="LOGOUT"/>
                    </div>
                </form>
                <br />
            </div>
