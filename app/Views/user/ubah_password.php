                ...
                <div class="container-fluid">
                    ...
                    <form action="<?= base_url(); ?>/user/save_password_baru" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="list-group-item p-3">
                                        <div class="row align-items-start">
                                            ...
                                            <div class="col mb-8pt mb-md-0">
                                                <input name="email" value="<?= $session->get('email')?>" type="email" class="form-control" placeholder="Masukan Email User" readonly/>
                                            </div>
                                        </div>
                                    </div>
