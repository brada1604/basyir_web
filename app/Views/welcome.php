...
<head>
    ...
    <!--====== Title ======-->
    <title>BASYIR - BOOSTER YOUR IMAN</title>
                ...
                <div class="w-full lg:w-1/2">
                    <div class="relative pb-8 mt-12 video-content wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <div class="relative mr-6 rounded-lg shadow-md video-wrapper">
                            ...
                            <div class="absolute top-0 left-0 flex items-center justify-center w-full h-full bg-#629C87 bg-opacity-25 rounded-lg video-icon">
            ...
            <div class="row testimonial-active wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.8s">
                <div class="w-full lg:w-1/3">
                    <div class="single-testimonial">
                        ...
                        <div class="mb-8">
                            <p>Aplikasi Basyir sangar cocok digunakan untuk kaula muda islami</p>
                        </div>
                        <div class="flex items-center testimonial-author">
                            <div class="relative author-image">
                                ...
                                <img class="author" src="assets/images/bagus.jpg" alt="author">
                            </div>
                            <div class="author-content media-body">
                                <h6 class="mb-1 text-xl font-bold text-gray-900">Bagus Nugroho</h6>
                                <p>Leader Project</p>
                            </div>
                        </div>
                ...
                <?php 
                    $nomor = 1; 
                    foreach($getReviewLandingPage as $grlp):
                ?>
                <div class="col-lg-4">
                    <div class="single-testimonial">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <div class="star">
                                <ul class="flex">
                                    <?php
                                        $x = intval($grlp->bintang);
                                        $a = 1;

                                        while($a <= $x) {
                                            echo '<li><i class="lni lni-star-filled text-theme-color-2"></i></li>';
                                            $a++;
                                        }
                                    ?>
                                </ul>
                        ...
                        <div class="flex items-center testimonial-author">
                            <div class="relative author-image">
                                <img class="shape" src="assets/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="<?= base_url($grlp->gambar_reviewer); ?>" alt="author">
                            </div>
                            <div class="author-content media-body">
                                <h6 class="mb-1 text-xl font-bold text-gray-900"><?= $grlp->reviewer?></h6>
                                <p><?= $grlp->pekerjaan?></p>
                            </div>
                        </div>
                    </div> <!-- single testimonial -->
