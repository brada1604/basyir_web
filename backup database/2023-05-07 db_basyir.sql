...
CREATE TABLE `tbl_rencana_kegiatan`  (
  ...
  CONSTRAINT `tbl_rencana_kegiatan_ibfk_1` FOREIGN KEY (`id_amalan_yaumi`) REFERENCES `tbl_amalan_yaumi` (`id_amalan_yaumi`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `tbl_rencana_kegiatan_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
